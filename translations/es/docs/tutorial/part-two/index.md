---
title: Introducción al uso de CSS en GatsbyJs
typora-copy-images-to: ./
---

Bienvenidos a la parte dos del tutorial de Gatsby!

## ¿Qué incluye este tutorial?

En esta parte vas a explorar las opciones para estilizar páginas web heachas con Gatsby y ir más a fondo usando componentes de React para construir nuestros sitios.

## Creando estilos globales

Todo sitio web tiene alguna clase de estilos globales. Esto incluye cosas como la
tipografía y colores de fonde. Estos estilos
...
Constantemente las personas usan algo como Boostrap or Foundation para sus estilos
globales. El problema con esto, es que estos estilos son díficil de modificar y que
estos no estan pensados para funcionar correctamente con componentes de React.

Para este tutorial, exploraremos una librería llamada
...
Typography.js es una librería de JavaScript que genera CSS tipográfico.

En vez de configurar directamente la propiedad `font-size` de diferentes elementos HTML,
le dices a Typography.js cosas como el `baseFontSize` and `baseLineHeight` deseados y
basados en estos, este nos generara la base del CSS para todos tus elementos.

Esto hace trivial el cambio del tamaño de la fuente para todos los elementos sin tener
que modificar directamente docenas de reglas de CSS.

Usar esto se va similar a algo como lo siguiente:
...
Pero antes de empezar a trabajar con Typography.js, hechemosle una mirada rápida
y hablemos de los plugins de Gatsby.

Seguramente estas familiarizado con la idea de plugins. Muchos sistemas
